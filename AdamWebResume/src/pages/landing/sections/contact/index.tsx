    ...
    <section id="contact" className="section">
      ...
      {/* <div className="content-670">
        <div className="contact-form">
          <form action="https://formspree.io/f/xoqoedyn" method="post" onSubmit={handleSubmit}>
            <p>
              <input
                id="name"
                type="text"
      ...
      <h1>Phome : 0954259994</h1>
      <h1>Emain: adamcoe128@gmain.com</h1>
      <h1>Address : 175/1 moo.1 Subdistrict. Srisakorn, District. Srisakorn, Province. Narathiwa      </h1>
